...
void loop(void) {
  ...
  int AZ_CURR_DIFF = (max(X, AZIMUT_CURRENT) - min(X, AZIMUT_CURRENT)); //CALCOLO LA DIFFERENZA TRA AZIMUT_CURRENT E VALORE ATTUALE
  int EL_CURR_DIFF = (max(Y, ELEVAZ_CURRENT) - min(Y, ELEVAZ_CURRENT)); //CALCOLO LA DIFFERENZA TRA VAR_ELEVAZT_CURRENT E VALORE ATTUALE
